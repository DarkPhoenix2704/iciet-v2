const Tracks = [
    ...
    {
        id: 2,
        title: 'Track 2 Computer Science and Engineering',
        subs: [
    ...
    {
        id: 3,
        title: 'Track 3 Electrical & Electronics Engineering',
        subs: [
    ...
    {
        id: 4,
        title: 'Track 4 Civil Engineering',
        subs: [
    ...
    {
        id: 5,
        title: 'Track 5 Electronics and Communications Engineering',
        subs: [
            'Post-CMS VLSI',
    ...
    {
        id: 6,
        title: 'Track 6 Mechanical Engineering',
        subs: [
